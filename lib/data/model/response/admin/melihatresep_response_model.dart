...
class MelihatResepResponseModel {
  final String? message;
  final List<Datum>? data;

  MelihatResepResponseModel({
    this.message,
    this.data,
  });

  factory MelihatResepResponseModel.fromJson(String str) => MelihatResepResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory MelihatResepResponseModel.fromMap(Map<String, dynamic> json) => MelihatResepResponseModel(
...
class Datum {
  ...
  final String? potoObat; // Ini sekarang akan berisi URL lengkap dari API
  final String? keteranganObat;
  // final String? potoObatUrl; // <--- BARIS INI DIHAPUS
  ...
  Datum({
    ...
    this.patientId,
    this.pendaftaranId,
    this.potoObat, // Ini sekarang akan berisi URL lengkap dari API
    this.keteranganObat,
    // this.potoObatUrl, // <--- BARIS INI DIHAPUS
    this.pendaftaran,
  });
  ...
  factory Datum.fromMap(Map<String, dynamic> json) => Datum(
        ...
        potoObat: json["poto_obat"], // <--- Sekarang membaca URL lengkap dari key "poto_obat"
        keteranganObat: json["keterangan_obat"],
        // potoObatUrl: json["poto_obat_url"], // <--- BARIS INI DIHAPUS
  ...
  Map<String, dynamic> toMap() => {
        ...
        "poto_obat": potoObat, // <--- Sekarang mengirim URL lengkap dari key "poto_obat"
        "keterangan_obat": keteranganObat,
        // "poto_obat_url": potoObatUrl, // <--- BARIS INI DIHAPUS
