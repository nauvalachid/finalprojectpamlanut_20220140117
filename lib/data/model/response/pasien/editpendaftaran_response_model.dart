...
class EditPendaftaranResponseModel {
    final String? message;
    final Data? data;

    EditPendaftaranResponseModel({
        this.message,
        this.data,
    });

    factory EditPendaftaranResponseModel.fromJson(String str) => EditPendaftaranResponseModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory EditPendaftaranResponseModel.fromMap(Map<String, dynamic> json) => EditPendaftaranResponseModel(
